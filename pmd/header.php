...
<head>
	...
	<link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/demos/interior-design/interior-design.css" type="text/css" />
	...
	<link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/demos/interior-design/css/fonts.css" type="text/css" />
	...
	<![endif]-->
	<link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/css/colors.php?color=1c85e8" type="text/css" />
				...
				<div class="container clearfix">
					...
					<div class="market-header clearfix">
						...
						<div>
							...
							============================================= -->
							<div id="logo">
								<a href="demo-interior-design.html" class="standard-logo"><img src="demos/interior-design/images/logo.png" alt="Canvas Logo"></a>
								<a href="demo-interior-design.html" class="retina-logo"><img src="demos/interior-design/images/logo@2x.png" alt="Canvas Logo"></a>
							</div><!-- #logo end -->
